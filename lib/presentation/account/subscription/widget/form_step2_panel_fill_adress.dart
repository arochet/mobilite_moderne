...
class PanelFormFillAdress extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    print('build PanelFormFillAdress');
    return Form(
      autovalidateMode: AutovalidateMode.always,
      child: ListView(
        children: [
          const SizedBox(height: 14),
          Text("Votre adresse de facturation", style: Theme.of(context).textTheme.titleSmall),
          ...
          TextFormField(
            ...
            validator: (_) {
              ...
              if (sub.showErrorMessages && (sub.address.country == null || sub.address.country!.length == 0))
          ...
          TextFormField(
            ...
            validator: (_) {
              final sub = ref.read(subscriptionNotifierProvider);
              if (sub.showErrorMessages && (sub.address.city == null || sub.address.city!.length == 0))
          ...
          TextFormField(
            ...
            autocorrect: false,
            onChanged: (value) {
              ref.read(subscriptionNotifierProvider.notifier).onUpdateAddressField(postalCode: value);
            },
            validator: (_) {
              final sub = ref.read(subscriptionNotifierProvider);
          ...
          TextFormField(
            ...
            validator: (_) {
              final sub = ref.read(subscriptionNotifierProvider);
              if (sub.showErrorMessages && (sub.address.line1 == null || sub.address.line1!.length == 0))
